...
public class InferknightAI : MonoBehaviour
{
    ...
    private void ShootAwayFromClosestPlayer(Vector3 shootAwayFrom)
    {
    ...
    private void Dodge()
    {
        if (wallToShootAt.magnitude != 0)
        {
            ...
            else if (randomChance == 2) { ShootGrappleTowards(closestPlayer.transform.position); }
        }
...
/// NOTES
/// needs to launch at the enemy as a dodge chance
